...
void write_to_vtk2d(double* u, const char* path, const char** data, const int _N[2], const double o[2], const double h[2], const int gs, const int k)
{
    FILE* f;
    int i1, i2, j;
    f = fopen(path, "w");
