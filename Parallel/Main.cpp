...
#include "C:\Users\ilina\source\repos\Parallel\brusselator.h" //выберем пока один дл€ определенности
...
void prl_reduction(matrix_t* Am, matrix_t* Bm, matrix_t* Cm, node_t* Fm, node_t* u1) //суд€ по всему речь о массивах матриц, триндец
{
	int s, j;
	// for each proccesses
	for (s = 1; s < N_prl; s *= 2) {
